...
c++ -s -static -O2 -ffast-math -fomit-frame-pointer -fstrict-aliasing -funroll-loops -I/usr/local/include -L/usr/local/lib anatolia.cpp -lgsl -lgslcblas -o ANATOLIA
